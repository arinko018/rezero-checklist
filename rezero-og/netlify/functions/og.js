...
exports.handler = async (event) => {
  ...
  const title2 = isEn ? 'Read / Watch Checklist' : 'Read / Watch Checklist';
  const label  = isEn ? 'Completion Rate' : 'Completion Rate';
  const items  = isEn ? `${done} / ${total} items` : `${done} / ${total} items`;
...
<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="600" y="158" text-anchor="middle"
        font-family="Arial, Helvetica, sans-serif" font-size="44" font-weight="bold" fill="#9c27b0">Re:ZERO</text>
  <text x="600" y="200" text-anchor="middle"
        font-family="Arial, Helvetica, sans-serif" font-size="24" fill="#b039c8">Starting Life in Another World</text>
  <text x="600" y="234" text-anchor="middle"
        font-family="Arial, Helvetica, sans-serif" font-size="20" font-weight="bold" fill="#9c27b0">${title2}</text>
  ...
  <text x="600" y="293" text-anchor="middle"
        font-family="Arial, Helvetica, sans-serif" font-size="22" fill="#9c3fb0">${label}</text>

  <!-- Big % number -->
  <text x="600" y="415" text-anchor="middle"
        font-family="Arial Black, Arial, sans-serif" font-size="110" font-weight="900"
        fill="url(#pctg)" filter="url(#glow)">${pct}%</text>

  <!-- Items count -->
  <text x="600" y="468" text-anchor="middle"
        font-family="Arial, Helvetica, sans-serif" font-size="24" fill="#9040b8">&#9733; ${items} &#9733;</text>
  ...
  <text x="608" y="36"  font-size="16" fill="rgba(255,255,255,0.8)" text-anchor="middle">&#10022;</text>
  <text x="295" y="48"  font-size="13" fill="rgba(255,255,255,0.75)" text-anchor="middle">&#10022;</text>
  <text x="905" y="42"  font-size="14" fill="rgba(255,255,255,0.75)" text-anchor="middle">&#10022;</text>
</svg>`;
  ...
  try {
    ...
    return { statusCode: 500, body: 'Image generation error: ' + err.message };
  }
};
